...
/**
 * Specifies that a new class should be generated by instantiating the annotated, generic class with the given
 * type (or types if there are multiple generic type arguments).
 */
