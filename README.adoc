...
:INSTANTIATE:       pass:quotes[link:../main/java/com/kt/codegen/Instantiate.java[`@Instantiate`]]
:DERIVE:            pass:quotes[link:../main/java/com/kt/codegen/Derive.java[`@Derive`]]
:REPLACE:           pass:quotes[link:../main/java/com/kt/codegen/Replace.java[`@Replace`]]]
:SRC_DIR:           ../main/java/com/kt/codegen/demo
:GEN_DIR:           ../../target/generated-sources/annotations/com/kt/codegen/demo
:SOURCE_DIRECTORY:  pass:quotes[link:../main/java/com/kt/codegen/SourceDirectory.java[`@SourceDirectory`]]
