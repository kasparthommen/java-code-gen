...
[source,java]
----
include::../../java-template-demo/src/main/java/com/kt/template/demo/list1/MyList.java[]
----
...
[source,java]
----
include::../../java-template-demo/src/main/java/com/kt/template/demo/list2/MyList.java[]
----

This will generate the following class:
[source,java]
----
include::../../java-template-demo/target/generated-sources/annotations/com/kt/template/demo/list2/MyListString.java[]
----
...
[source,java]
----
include::../../java-template-demo/src/main/java/com/kt/template/demo/list3/MyList.java[]
----

And our list compiles:
[source,java]
----
include::../../java-template-demo/target/generated-sources/annotations/com/kt/template/demo/list3/MyListString.java[]
----
...
[source,java]
----
include::../../java-template-demo/src/main/java/com/kt/template/demo/list4/MyList.java[]
----

which produces `+MyListString+` from above plus the following class:
[source,java]
----
include::../../java-template-demo/target/generated-sources/annotations/com/kt/template/demo/list4/MyListDouble.java[]
----
...
[source,java]
----
include::../../java-template-demo/src/main/java/com/kt/template/demo/map/MyMap.java[]
----
...
[source,java]
----
include::../../java-template-demo/src/main/java/com/kt/template/demo/double1/MyDoubleList.java[]
----
...
[source,java]
----
include::../../java-template-demo/src/main/java/com/kt/template/demo/double2/MyDoubleList.java[]
----

This will generate two classes:
[source,java]
----
include::../../java-template-demo/target/generated-sources/annotations/com/kt/template/demo/double2/MyFloatList.java[]
----
...
[source,java]
----
include::../../java-template-demo/target/generated-sources/annotations/com/kt/template/demo/double2/MyLongList.java[]
----
